...
def execution(e, p, g):
    ...
    with open('C:\\Users\\valen\\Documents\\GitHub\\2019_Pansanella\\datasets\\out\\mediamodel\\e{}_p{}_g{}_iterationsdict_onemedia.pickle'.format(e,p,g), 'wb') as outfile:
    ...
    with open('C:\\Users\\valen\\Documents\\GitHub\\2019_Pansanella\\datasets\\out\\mediamodel\\e{}_p{}_g{}_finalops_onemedia.ops'.format(e, p, g), 'w') as outfile:
        for o in ops:
            outfile.write(str(o)+'\n')
    with open('C:\\Users\\valen\\Documents\\GitHub\\2019_Pansanella\\datasets\\out\\mediamodel\\e{}_p{}_g{}_singleexecution_onemedia.csv'.format(e,p,g), 'a+') as outfile:
