...
def execution(p, e, g, g_media, k, max_iterations=1000000, n=100, nruns=5):
    ...
    for r in range(nruns):
        ...
        finalopsfile = open('../../datasets/out/mediamodel/singlerundata/finalops_run{}_media_model_{}_{}_{}_{}_{}_{}_onemedia.csv'.format(r, p, k, e, g, g_media, max_iterations), 'w+')        
    ...
    resultfile = open('../../datasets/out/mediamodel/csvfiles/results_media_model_{}_{}_{}_{}_{}_{}_onemedia.csv'.format(p, k, e, g, g_media, max_iterations), 'w+')
