...
def execution(e, p, g):
    ...
    with open('C:\\Users\\valen\\Documents\\GitHub\\2019_Pansanella\\datasets\\out\\mediamodel\\e{}_p{}_g{}_iterationsdict_moreextreme.pickle'.format(e,p,g), 'wb') as outfile:
    ...
    with open('C:\\Users\\valen\\Documents\\GitHub\\2019_Pansanella\\datasets\\out\\mediamodel\\e{}_p{}_g{}_finalops_moreextreme.ops'.format(e, p, g), 'w') as outfile:
        for o in ops:
            outfile.write(str(o)+'\n')
    with open('C:\\Users\\valen\\Documents\\GitHub\\2019_Pansanella\\datasets\\out\\mediamodel\\e{}_p{}_g{}_singleexecution_moreextreme.csv'.format(e,p,g), 'a+') as outfile:
